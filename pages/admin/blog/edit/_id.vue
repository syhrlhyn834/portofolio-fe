<template>
  <div class="container mx-auto px-4">
    ...
    <h1 class="text-2xl font-semibold mb-4">Edit Blog</h1>
...
export default {
  ...
  data() {
    return {
      ...
      editorConfig: {
        removePlugins: ['Title'],
        simpleUpload: {
          uploadUrl: 'http://localhost/portofolio-app/public/api/web/blogs/storeImage'
        }
      }
    }
  },
  ...
  async mounted() {
    try {
      ...
      const blogResponse = await this.$axios.get(`/api/admin/blogs/${this.$route.params.id}`);
