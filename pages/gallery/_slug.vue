      ...
      <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
          ...
          <li class="inline-flex items-center">
            ...
            <NuxtLink v-if="galleries" :to="{ name: 'galleries-slug', params: { slug: galleries.slug } }" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ galleries.title }}</NuxtLink>
          </li>
        </ol>
      </nav>
    </div>
